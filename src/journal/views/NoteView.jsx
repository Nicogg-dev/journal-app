    ...
    return (
        <div className="flex h-full flex-col mb-1 animate__animated animate__fadeInRight animate__faster">
            <div className="flex col-span-12 flex-row justify-between">
                ...
                <div>
                    <button className="flex gap-2 hover:bg-gray-300 pb-2 pt-1 px-2 hover:rounded-xl text-2xl items-end justify-center text-center active:bg-gray-500">
            ...
            <div className="flex flex-col">
                <input type="title" className="text-xl font-light text-gray-800 dark:text-dark bg-gray-200 p-2 rounded-lg mt-4" placeholder="Ingrese un titulo" />
            </div>
            <div className="flex flex-col mt-2">
                <textarea rows='4' type="text" className="text-xl font-light text-gray-800 dark:text-dark bg-gray-200 p-2 rounded-lg" placeholder="¿Que sucedió el día de hoy?" />
            </div>
