...
export const NavBar = ({ drawerWidth = 240 }) => {
    ...
    return (
        ...
        <nav
            className="fixed z-50 h-16 w-full bg-white border-gray-200 dark:bg-gray-900">
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <button href="" className="flex items-center space-x-3 rtl:space-x-reverse" onClick={onLogout}>
